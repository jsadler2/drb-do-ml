...
rule make_predictions:
    input:
        ...
        "../../../out/well_obs_io_ADJ_CAT_RDX.zarr",
    output:
        "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/preds_adj_RDX.feather",
    run:
        weight_dir = input[1] + "/"
...
rule make_filtered_predictions:
    input:
        "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/preds_adj_RDX.feather"
    output:
        "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/{partition}_preds_adj_RDX.feather"
    run:
...
rule combine_metrics:
     input:
          "../../../out/well_obs_io.zarr",
          "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/trn_preds_adj_RDX.feather",
          "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/val_preds_adj_RDX.feather",
          "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/val_times_preds_adj_RDX.feather"
     output:
          "{outdir}/nstates_{nstates}/nep_{epochs}/rep_{rep}/{metric_type}_metrics_adj_RDX.csv"
     params:
         grp_arg = get_grp_arg
     run:
